      ...
      <Row>
        ...
        <div className="aboutContent">
          ...
          <p>
            ...
            هذه المبادرة على المملكة كافة، و أيضًا تساهم في تحفيز جميع فئات المجتع على أن تكون لهم البصمة والدور الفعال في المساعة في تحقيق هذه المبادة و رؤية المملكة 2030. 
          </p>
        </div>
        </Col>
        <Col>
